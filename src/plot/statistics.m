function [medias_modelo_grado_criterio_nodo, int_conf_modelo_grado_criterio_nodo] = statistics(datos)   
    ...
    int_conf_por_nodo = zeros(20,5);
    int_conf_por_nodo_y_criterio = cell(6,1);
    int_conf_por_nodo_criterio_y_grado = cell(3,1);
    int_conf_modelo_grado_criterio_nodo = cell (2,1);
